...
function newSample = testronGetNewSample(varargin)
...
elseif nargin == 3 || nargin == 4
    ...
    %if staliro_opt.varying_cp_times == 1
        ...
        r=testronMcGenerateRandomNumber([l1;alpha],[l2;beta],dispL);
...
%         end
        ...
        % Arend Aerts sampling - don't divide by the norm (comment next
        % line)
        % rUnitVector = rUnitVector/ norm(rUnitVector);
        ...
        r=testronMcGenerateRandomNumber(l1,l2,dispL);
